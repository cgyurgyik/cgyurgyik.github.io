...
- A compiler provides automatic optimization, but can quickly become a burden for the performance engineer. This is [highlighted](http://lua-users.org/lists/lua-l/2011-02/msg00742.html) by Mike Pal in a thread about the LuaJIT compiler. This is also a driving force behind the Exo Language (REF), which attempts to *externalize* the compiler so that the optimizations are transparent.
