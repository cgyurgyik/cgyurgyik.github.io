...
In ["Eigenvectors from eigenvalues: A survey of a basic identity in linear algebra"](https://arxiv.org/pdf/1908.03795.pdf) by Denton et al., the _eigenvalue-eigenvector identity_ was rediscovered (with some ensuing drama, of course). It can be rewritten in the following manner:
