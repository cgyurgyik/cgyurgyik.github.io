...
Let's say we wanted to take a procedural program, such as:
...
SRAM: <img src="https://render.githubusercontent.com/render/math?math=f: \text{  a  } \rightarrow \text{  data  }">
 
CAM: <img src="https://render.githubusercontent.com/render/math?math=f: \text{  data  } \rightarrow \{ a_0, ..., a_n \}">
...
and compiles it down to hardware design. For a concrete example,
...
<font size="-1">Credits to [Rachit Nagim][rachit-nagim] for the motivating example below.</font>
...
<details><summary markdown="span"><b>Calyx CN-LPM Cells</summary>
...
<details><summary markdown="span"><b>Aside</b>: Calyx 8-bit CN-LPM </summary>
...
<details><summary markdown="span"><b>Aside</b>: Calyx 8-bit TCAM demonstration: `tcam_sim.data` </summary>
...
Running this requires installing the [calyx-py][calyx-py-installation] library.
