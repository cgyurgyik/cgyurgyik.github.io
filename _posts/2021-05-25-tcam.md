...
every possible input data with bit width N, we would need <img src="https://render.githubusercontent.com/render/math?math=2^N"> 
...
Another approach to this is trading off search speed (and area) for update speed. Rather than
