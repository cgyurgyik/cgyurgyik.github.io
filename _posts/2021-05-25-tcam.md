...
rows in our CAM! Most of the time, what we want instead is a way to say "I just want these bits to match, 
I don't really care about the rest." And thus, the ternary content-addressable memory (TCAM) was born.
