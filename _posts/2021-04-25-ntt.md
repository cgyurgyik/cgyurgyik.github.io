...
- [Fourier acronym soup: What are the DFT and FFT](#Fourier-acronym-soup:-What-are-the-DFT-and-FFT)
  * [A transform](###A-transform)
  * [A (continuous) Fourier Transform](###A-(continuous)-Fourier-Transform)
  * [A discrete Fourier Transform](###A-discrete-Fourier-Transform)
  * [An even faster Fourier Transform](###An-even-faster-Fourier-Transform)
- [What is the NTT](#What-is-the-NTT)
  * [Dirichlet's Prime Theorem](###Dirichlet-Prime-Theorem)
  * [Finding the primitive <img src="https://render.githubusercontent.com/render/math?math=$n$">th root of unity](###Finding-the-primitive-<img src="https://render.githubusercontent.com/render/math?math=$n$">th-root-of-unity)
  * [Finding a generator of the multiplicative group](###Finding-a-generator-of-the-multiplicative-group)
  * [Bringing it back: a naive NTT](###Bringing-it-back:-a-naive-NTT)
  * [What about a faster NTT?](###What-about-a-faster-NTT?)
  * [Round tripping it](###Round-tripping-it)
...
You may also find a variant of the code in our research group CUCAPRA's repository [nttstuff][ntt-stuff].
It is not well-documented, nor is it guaranteed to be correct. It was mostly used as a stepping stone for building 
