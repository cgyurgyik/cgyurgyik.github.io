...
for Faster Ideal Lattice-Based Cryptography," which instead uses <img src="https://render.githubusercontent.com/render/math?math=$\phi$">s as twiddle factors (as well as a few other small optimizations) <sup>[6](#fn6)</sup>. Here, <img src="https://render.githubusercontent.com/render/math?math=$\phi = \omega^{1/2} \mod q$">s.
